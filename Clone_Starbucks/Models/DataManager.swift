...
class DataManager {
    ...
    func makeDrinksData() {
        drinksDataArray = [
            ...
            Drinks(drinkImage: UIImage(named: "음료")!, drinkKo: "리저브 콜드 브루", drinkEn: "Reserve Cold Brew", detail: "리저브 커피 마스터의 정성으로 차갑게 추출한 깊고 부드러운 풍미의 커피", price: 0, ice: true),
            Drinks(drinkImage: UIImage(named: "음료")!, drinkKo: "리저브 콜드 브루", drinkEn: "Reserve Cold Brew", detail: "리저브 커피 마스터의 정성으로 차갑게 추출한 깊고 부드러운 풍미의 커피", price: 0, ice: true),
            Drinks(drinkImage: UIImage(named: "음료")!, drinkKo: "리저브 콜드 브루", drinkEn: "Reserve Cold Brew", detail: "리저브 커피 마스터의 정성으로 차갑게 추출한 깊고 부드러운 풍미의 커피", price: 0, ice: true),  Drinks(drinkImage: UIImage(named: "음료")!, drinkKo: "리저브 콜드 브루", drinkEn: "", detail: "리저브 커피 마스터의 정성으로 차갑게 추출한 깊고 부드러운 풍미의 커피", price: 0, ice: true),
            Drinks(drinkImage: UIImage(named: "음료")!, drinkKo: "리저브 콜드 브루", drinkEn: "Reserve Cold Brew", detail: "리저브 커피 마스터의 정성으로 차갑게 추출한 깊고 부드러운 풍미의 커피", price: 0, ice: true),  Drinks(drinkImage: UIImage(named: "음료")!, drinkKo: "리저브 콜드 브루", drinkEn: "", detail: "리저브 커피 마스터의 정성으로 차갑게 추출한 깊고 부드러운 풍미의 커피", price: 0, ice: true),
            Drinks(drinkImage: UIImage(named: "음료")!, drinkKo: "리저브 콜드 브루", drinkEn: "Reserve Cold Brew", detail: "리저브 커피 마스터의 정성으로 차갑게 추출한 깊고 부드러운 풍미의 커피", price: 0, ice: true),  Drinks(drinkImage: UIImage(named: "음료")!, drinkKo: "리저브 콜드 브루", drinkEn: "", detail: "리저브 커피 마스터의 정성으로 차갑게 추출한 깊고 부드러운 풍미의 커피", price: 0, ice: true)]
    }
